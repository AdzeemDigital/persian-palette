/**
 * Preserved v2.1 source annotations for 72 colors across 12 palettes.
 * Historical and material claims in this source are unverified, not authentication.
 */
import type { RawPaletteDefinition } from '../types/palette.js';

export const RAW_PALETTES: Record<string, RawPaletteDefinition> = {
  "isfahan-tiles": {
    "id": "isfahan-tiles",
      ...
      },
      {
        ...
        "evidence": {
          "mineralogical": {
            ...
            "chemicalFormula": "Cu(CH₃COO)₂·[Cu(OH)₂]₂",
      ...
      },
      {
        ...
        "evidence": {
          ...
          "geo": {
            ...
            "unescoSiteId": "UNESCO Ref: 1397 (Masjed-e Jāmé)"
          },
          "physics": {
