...
export const CANONICAL_TOKEN_KEYS = Object.freeze({
...
export const colorTokenKey = (color) => color.tokenKey ?? CANONICAL_TOKEN_KEYS[color.id] ?? color.nameEn.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/^-|-$/g, '');
